...
/**
 * This class represents an embedded literal, e.g. 'Title'. toString() does not
 * yet handle embedded quotes.
 */
public class FormatString extends FormatElement {
	...
	public void read(FormatInputList vp, InputStreamAndBuffer in, FormatMap format_map) throws InputFormatException {
		...
		if (!(this.s.equals(s)))
			throw new UnmatchedStringOnReadException(s, vp.getPtr(), this.toString(), in.getLineErrorReport());
