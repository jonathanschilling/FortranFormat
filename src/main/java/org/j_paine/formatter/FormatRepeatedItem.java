...
/**
 * This class represents a repeated item, e.g. 3F12.5 or 3X. The integer r gives
 * the repetition factor. The item may be either a format element, or an entire
 * format. To cater for either, we hold it in a FormatUniv object (this is why
 * we introduced the class FormatUniv).
 */
